...
function dv_baseHandler(){function K(b){var c=window._dv_win,e=0;try{for(;10>e;){if(c[b]&&"object"===typeof c[b])return!0;if(c==c.parent)break;e++;c=c.parent}}catch(d){}return!1}function L(){var b="http:";"http:"!=window._dv_win.location.protocol&&(b="https:");return b}function E(b,c){var e=document.createElement("iframe");e.name=window._dv_win.dv_config.emptyIframeID||"iframe_"+A();e.width=0;e.height=0;e.id=c;e.style.display="none";e.src=b;return e}function B(b,c,e){e=e||150;var d=window._dv_win||
window;if(d.document&&d.document.body)return c&&c.parentNode?c.parentNode.insertBefore(b,c):d.document.body.insertBefore(b,d.document.body.firstChild),!0;if(0<e)setTimeout(function(){B(b,c,--e)},20);else return!1}function M(b){var c=window._dv_win.dv_config=window._dv_win.dv_config||{};c.cdnAddress=c.cdnAddress||"cdn.doubleverify.com";return'<html><head><script type="text/javascript">('+function(){try{window.$dv=window.$dvbs||parent.$dvbs,window.$dv.dvObjType="dvbs"}catch(e){}}.toString()+')();\x3c/script></head><body><script type="text/javascript">('+
(b||"function() {}")+')("'+c.cdnAddress+'");\x3c/script><script type="text/javascript">setTimeout(function() {document.close();}, 0);\x3c/script></body></html>'}function F(b){var c=0,e;for(e in b)b.hasOwnProperty(e)&&++c;return c}function N(b,c){a:{var e={};try{if(b&&b.performance&&b.performance.getEntries){var d=b.performance.getEntries();for(b=0;b<d.length;b++){var f=d[b],n=f.name.match(/.*\/(.+?)\./);if(n&&n[1]){var m=n[1].replace(/\d+$/,""),k=c[m];if(k){for(var h=0;h<k.stats.length;h++){var q=
k.stats[h];e[k.prefix+q.prefix]=Math.round(f[q.name])}delete c[m];if(!F(c))break}}}}var p=e;break a}catch(z){}p=void 0}if(p&&F(p))return p}function O(b,c){var e,d=window._dv_win.document.visibilityState;window[b.tagObjectCallbackName]=function(f){var n=window._dv_win.$dvbs;if(n){var m=c?"https:":L();e=f.ImpressionID;n.tags.add(f.ImpressionID,b);n.tags[f.ImpressionID].set({tagElement:b.script,impressionId:f.ImpressionID,dv_protocol:b.protocol,protocol:m,uid:b.uid,serverPublicDns:f.ServerPublicDns,
...
hasPassback:!1,tagAdTag:c,tagPassback:e}};return f(b)}function G(b,c,e,d,f,n,m,k,h,q,p,z){void 0==c.dvregion&&(c.dvregion=0);var r=dv_GetParam(l,"useragent");l=window._dv_win.$dvbs.CommonData;if(void 0!=l.BrowserId&&void 0!=l.BrowserVersion&&void 0!=l.BrowserIdFromUserAgent)var t={ID:l.BrowserId,version:l.BrowserVersion,ID_UA:l.BrowserIdFromUserAgent};else t=Q(r?decodeURIComponent(r):navigator.userAgent),l.BrowserId=t.ID,l.BrowserVersion=t.version,l.BrowserIdFromUserAgent=t.ID_UA;var g="";void 0!=
c.aUrl&&(g="&aUrl="+c.aUrl);var y="";try{d.depth=R(d);var w=S(d,e,t);if(w&&w.duration){var u="&dvp_strhd="+w.duration;u+="&dvpx_strhd="+w.duration}w&&w.url||(w=T(d));w&&w.url&&(g="&aUrl="+encodeURIComponent(w.url),y="&aUrlD="+w.depth);var x=d.depth+f;n&&d.depth--}catch(H){u=y=g=x=d.depth=""}a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var v=1;break a}}catch(H){}v=0}f=function(){function b(c){f++;var d=c.parent==c;return c.mraid||d?c.mraid:20>=f&&b(c.parent)}var c=window._dv_win||
window,f=0;try{return b(c)}catch(da){}}();var l=c.script.src;v="&ctx="+(dv_GetParam(l,"ctx")||"")+"&cmp="+(dv_GetParam(l,"cmp")||"")+"&plc="+(dv_GetParam(l,"plc")||"")+"&sid="+(dv_GetParam(l,"sid")||"")+"&advid="+(dv_GetParam(l,"advid")||"")+"&adsrv="+(dv_GetParam(l,"adsrv")||"")+"&unit="+(dv_GetParam(l,"unit")||"")+"&isdvvid="+(dv_GetParam(l,"isdvvid")||"")+"&uid="+c.uid+"&tagtype="+(dv_GetParam(l,"tagtype")||"")+"&adID="+(dv_GetParam(l,"adID")||"")+"&app="+(dv_GetParam(l,"app")||"")+"&sup="+(dv_GetParam(l,
"sup")||"")+"&isovv="+v+"&gmnpo="+(dv_GetParam(l,"gmnpo")||"")+"&crt="+(dv_GetParam(l,"crt")||"");"1"==dv_GetParam(l,"foie")&&(v+="&foie=1");f&&(v+="&ismraid=1");(f=dv_GetParam(l,"xff"))&&(v+="&xff="+f);(f=dv_GetParam(l,"vssd"))&&(v+="&vssd="+f);(f=dv_GetParam(l,"apifw"))&&(v+="&apifw="+f);(f=dv_GetParam(l,"vstvr"))&&(v+="&vstvr="+f);(f=dv_GetParam(l,"tvcp"))&&(v+="&tvcp="+f);p&&(v+="&urlsrc=sf");z&&(v+="&sfe=1");u&&(v+=u);r&&(v+="&useragent="+r);t&&(v+="&brid="+t.ID+"&brver="+t.version+"&bridua="+
t.ID_UA);v+="&dup="+dv_GetParam(l,"dup");try{v+=dv_AppendIQPAParams(l)}catch(H){}(p=dv_GetParam(l,"turl"))&&(v+="&turl="+p);(p=dv_GetParam(l,"tagformat"))&&(v+="&tagformat="+p);v+=V();q=q?"&dvf=0":"";p=K("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||c.protocol+"//"+(window._dv_win.dv_config.bsAddress||"rtb"+c.dvregion+".doubleverify.com")+"/verify.js")+"?jsCallback="+c.callbackName+"&jsTagObjCallback="+c.tagObjectCallbackName+"&num=6"+v+"&srcurlD="+d.depth+"&ssl="+c.ssl+q+p+"&refD="+
x+c.tagIntegrityFlag+c.tagHasPassbackFlag+"&htmlmsging="+(m?"1":"0");(d=dv_GetDynamicParams(l,"dvp").join("&"))&&(c+="&"+d);(d=dv_GetDynamicParams(l,"dvpx").join("&"))&&(c+="&"+d);if(!1===k||h)c=c+("&dvp_isBodyExistOnLoad="+(k?"1":"0"))+("&dvp_isOnHead="+(h?"1":"0"));e="srcurl="+encodeURIComponent(e);(k=W())&&(e+="&ancChain="+encodeURIComponent(k));k=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(k=2E3);if(h=dv_GetParam(l,"referrer"))h="&referrer="+h,c.length+h.length<=
k&&(c+=h);(h=dv_GetParam(l,"prr"))&&(c+="&prr="+h);(h=dv_GetParam(l,"iframe"))&&(c+="&iframe="+h);(h=dv_GetParam(l,"gdpr"))&&(c+="&gdpr="+h);(h=dv_GetParam(l,"gdpr_consent"))&&(c+="&gdpr_consent="+h);g.length+y.length+c.length<=k&&(c+=y,e+=g);(g=X())&&(c+="&m1="+g);(g=Y())&&0<g.f&&(c+="&bsig="+g.f,c+="&usig="+g.s);g=Z();0<g&&(c+="&hdsig="+g);navigator&&navigator.hardwareConcurrency&&(c+="&noc="+navigator.hardwareConcurrency);c+=aa();g=ba();c+="&vavbkt="+g.vdcd;c+="&lvvn="+g.vdcv;""!=g.err&&(c+="&dvp_idcerr="+
encodeURIComponent(g.err));"prerender"===window._dv_win.document.visibilityState&&(c+="&prndr=1");(l=dv_GetParam(l,"wrapperurl"))&&1E3>=l.length&&c.length+l.length<=k&&(c+="&wrapperurl="+l);c+="&"+b.getVersionParamName()+"="+b.getVersion();b="&eparams="+encodeURIComponent(C(e));c=c.length+b.length<=k?c+b:c+"&dvf=3";window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&(window.performance.mark("dv_create_req_end"),window.performance.measure("dv_creqte_req",
...
c,d){for(var e in b)if(-1<e.indexOf(c)&&(!d||d(b[e])))return!0;return!1},d=function(c,d,e){d&&-1==b.indexOf(e)&&b.push((c==window.top?-1:1)*e)};try{return function(){for(var b=window,d=0;10>d&&(c(b),b!=window.top);d++)try{b.parent.document&&(b=b.parent)}catch(m){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(f){return{vdcv:28,vdcd:"-999",err:f.message||"unknown"}}}function R(b){for(var c=0;10>c&&b!=window._dv_win.top;)c++,b=b.parent;return c}function S(b,c,e){try{var d;if(!(d=e.ID==$dvbs.Enums.BrowserId.IE)){if(b==
window._dv_win.top)var f=$dvbs.Enums.TrafficScenario.OnPage;else{e=b;try{for(var n=0;window._dv_win.top!=e&&10>=n;){var m=e.parent;if(!m.document)break;e=m;n++}}catch(U){}f=e==window._dv_win.top?$dvbs.Enums.TrafficScenario.SameDomain:$dvbs.Enums.TrafficScenario.CrossDomain}d=f!=$dvbs.Enums.TrafficScenario.CrossDomain}if(d)return null;b.performance&&b.performance.mark&&b.performance.mark("dv_str_html_start");if(c){var k=c.toString().match(/^(?:https?:\/\/)?[\w\-\.]+\/[a-zA-Z0-9]/gi);if(k&&0<k.length)return null}var h=
b.document;if(h&&h.referrer){var q=h.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),p=new RegExp('(?:w{0,4}=")?'+q+"[^&\"; %,'\\$\\\\\\|]+","gi");c=/banner|adprefs|safeframe|sandbox|sf\.html/gi;d=/^\w{0,4}="/gi;var z=I(h,"script","src",p,c,d);if(!z){var r=h.referrer;f="";var t=h.getElementsByTagName("script");if(t)for(m=0;!f&&m<t.length;){var g=t[m].innerHTML;if(g&&-1!=g.indexOf(r)){var y=g.match(p);f=J(y,c,d)}m++}(z=f)||(z=I(h,"a","href",p,c,d))}h=htmlUrl=z;a:{if(b.performance&&b.performance.mark&&
b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");b.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var w=b.performance.getEntriesByName("dv_str_html");if(w&&0<w.length){var u=w[0].duration.toFixed(2);break a}}u=null}return{url:h,depth:-1,duration:u}}}catch(U){}return null}function J(b,c,e){var d="";if(b&&0<b.length)for(var f=0;f<b.length;f++){var n=b[f];n.length>d.length&&null==n.match(c)&&0!=n.indexOf('src="')&&0!=n.indexOf('turl="')&&
(d=n.replace(e,""))}return d}function I(b,c,e,d,f,n){b=b.querySelectorAll(c+"["+e+'*="'+b.referrer+'"]');var m="";if(b)for(c=0;!m&&c<b.length;)m=b[c][e].match(d),m=J(m,f,n),c++;return m}function T(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window._dv_win.top,depth:0});for(var e,d=1,f=0;0<d&&100>f;){try{if(f++,e=c.shift(),d--,0<e.win.location.toString().length&&e.win!=b)return 0==e.win.document.referrer.length||0==e.depth?{url:e.win.location,depth:e.depth}:{url:e.win.document.referrer,
depth:e.depth-1}}catch(k){}var n=e.win.frames.length;for(var m=0;m<n;m++)c.push({win:e.win.frames[m],depth:e.depth+1}),d++}return{url:"",depth:""}}catch(k){return{url:"",depth:""}}}function W(){var b=window._dv_win[C("=@42E:@?")][C("2?46DE@C~C:8:?D")];if(b&&0<b.length){var c=[];c[0]=window._dv_win.location.protocol+"//"+window._dv_win.location.hostname;for(var e=0;e<b.length;e++)c[e+1]=b[e];return c.reverse().join(",")}return null}function C(b){new String;var c=new String,e;for(e=0;e<b.length;e++){var d=
b.charAt(e);var f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(d);0<=f&&(d="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((f+47)%94));c+=d}return c}function A(){return Math.floor(1E12*(Math.random()+""))}function Q(b){for(var c=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/|Edg/",verRegex:"(MSIE |rv:| Edge/|Edg/)"},
...
arguments)}},d="svg"===document.documentElement.nodeName.toLowerCase(),f=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):d?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},n=["Moz","O","ms","Webkit"],m=["moz","o","ms","webkit"],k={style:f("modernizr").style},h=function(b,c){function d(){g&&(delete k.style,delete k.modElem)}var e;for(e=["modernizr","tspan","samp"];!k.style&&
e.length;){var g=!0;k.modElem=f(e.shift());k.style=k.modElem.style}var p=b.length;for(e=0;e<p;e++){var h=b[e];~(""+h).indexOf("-")&&(h=cssToDOM(h));if(void 0!==k.style[h])return d(),"pfx"==c?h:!0}d();return!1},q=function(b,c,d){var f=b.charAt(0).toUpperCase()+b.slice(1),g=(b+" "+n.join(f+" ")+f).split(" ");if("string"===typeof c||"undefined"===typeof c)return h(g,c);g=(b+" "+m.join(f+" ")+f).split(" ");for(var k in g)if(g[k]in c){if(!1===d)return g[k];b=c[g[k]];return"function"===typeof b?e(b,d||
c):b}return!1};c(0,!0);c(1,q("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,q("shapeOutside","content-box",!0));return b}catch(p){return 0}}function D(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(e){}return b}function Y(){try{var b=D(),c=0,e=0,d=function(b,d,f){f&&(c+=Math.pow(2,b),e+=Math.pow(2,d))},f=b.document;d(14,0,b.playerInstance&&f.querySelector('script[src*="ads-player.com"]'));d(14,1,(b.CustomWLAdServer||
...
f.querySelector('path[id="cp-search-0"]'));d(20,13,function(){try{if(b.top==b&&0<b.document.getElementsByClassName("asu").length)for(var c=b.document.styleSheets,d=0;d<c.length;d++)for(var e=b.document.styleSheets[d].cssRules,f=0;f<e.length;f++)if("div.kk"==e[f].selectorText||"div.asu"==e[f].selectorText)return!0}catch(g){}}());a:{try{var n=null!=f.querySelector('div[id="kt_player"][hiegth]');break a}catch(p){}n=void 0}d(21,14,n);a:{try{var m=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');
break a}catch(p){}m=void 0}d(22,15,m);a:{try{var k=f.querySelector('object[data*="/VPAIDFlash.swf"]')&&f.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&f.querySelector('div[id*="desktopSubModal"]');break a}catch(p){}k=void 0}d(25,16,k);var h=navigator.userAgent;if(h&&-1<h.indexOf("Android")&&-1<h.indexOf(" wv)")&&b==window.top){var q=f.querySelector('img[src*="dealsneartome.com"]')||(b.__cads__?!0:!1)||0<f.querySelectorAll('img[src*="/tracker?tag="]').length;d(28,17,q||!1)}return{f:c,
s:e}}catch(p){return null}}function Z(){try{var b=D(),c=0,e=b.document;b==window.top&&""==e.title&&!e.querySelector("meta[charset]")&&e.querySelector('div[style*="background-image: url("]')&&(e.querySelector('script[src*="j.pubcdn.net"]')||e.querySelector('span[class="ad-close"]'))&&(c+=Math.pow(2,6));return c}catch(d){return null}}function aa(){try{var b="&fcifrms="+window.top.length;window.history&&(b+="&brh="+window.history.length);var c=D(),e=c.document;if(c==window.top){b+="&fwc="+((c.FB?1:0)+
(c.twttr?2:0)+(c.outbrain?4:0)+(c._taboola?8:0));try{e.cookie&&(b+="&fcl="+e.cookie.length)}catch(d){}c.performance&&c.performance.timing&&0<c.performance.timing.domainLookupStart&&0<c.performance.timing.domainLookupEnd&&(b+="&flt="+(c.performance.timing.domainLookupEnd-c.performance.timing.domainLookupStart));e.querySelectorAll&&(b+="&fec="+e.querySelectorAll("*").length)}return b}catch(d){return""}}var x=this,u=function(){function b(b,c){var e=[];c&&n.forEach(function(b){var d=dv_GetParam(c,b);
""!==d&&null!==d&&e.push(["dvp_"+b,d].join("="))});var h=window&&window._dv_win||{};h=h.dv_config=h.dv_config||{};h=dv_getDVBSErrAddress(h);var p=[f,d].join("="),g=["dvp_cert",k[b]].join("=");b=["dvp_jsErrMsg",b].join("=");h+=["/verify.js?ctx=818052&cmp=1619415&dvp_isLostImp=1&ssl=1",p,g,b,e.join("&")].join("&");(new Image(1,1)).src="https://"+h}function c(c,d){var e=window._dv_win.dv_config.bs_renderingMethod||function(b){document.write(b)};d="AdRenderedUponVerifyFailure__"+(d||"");if(x&&x.tagParamsObj&&
x.tagParamsObj.tagAdtag)try{e(x.tagParamsObj.tagAdtag)}catch(r){d+="__RenderingMethodFailed"}else x?x.tagParamsObj?x.tagParamsObj.tagAdtag||(d+="__HandlerTagParamsObjTagAdtag__Undefined"):d+="__HandlerTagParamsObj__Undefined":d+="__Handler__Undefined";b(d,c)}var e=!1,d,f,n=["ctx","cmp","plc","sid"],m=[x.constructor&&x.constructor.name||"UKDV","__",A()].join(""),k={VerifyLoadJSONPCallbackFailed:1,VerifyFailedToLoad:2},h={onResponse:function(d){e||(b("VerifyCallbackFailed",d),c(d,"VCF"))},onError:function(d){b("VerifyFailedToLoad",
d);c(d,"VFTL")}};h.reportError=b;h.isJSONPCalled=e;window._dv_win[m]={globalScopeVerifyErrorHandler:h};return{setVersionData:function(b,c){f=b;d=c},setIsJSONPCalled:function(b){e=b},getIsJSONPCalled:function(){return e},onLoad:dv_onResponse,onError:dv_onError,uniqueKey:m}}();this.createRequest=function(){window.performance&&window.performance.mark&&window.performance.mark("dv_create_req_start");var b=!1,c=window._dv_win,e=0,d=!1,f;try{for(f=0;10>=f;f++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=
c.parent,e++,b=!0;else{b=!1;break}else{0==f&&(b=!0);break}}catch(y){b=!1}a:{try{var n=c.$sf;break a}catch(y){}n=void 0}var m=(f=c.location&&c.location.ancestorOrigins)&&f[f.length-1];if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;a:{try{var k=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(y){}k=void 0}if(k&&(!f||0==k.indexOf(m))){b=k;var h=!0}d=!0}if(!window._dv_win.dvbsScriptsInternal||!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,
url:null};f=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();k=f.script;this.dv_script_obj=f;this.dv_script=k;window._dv_win.dvbsProcessed.push(f);window._dv_win._dvScripts.push(k);var q=k.src;this.dvOther=0;this.dvStep=1;var p=window._dv_win.dv_config?window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:window._dv_win.dv_config.dv_GetRnd?window._dv_win.dv_config.dv_GetRnd():
A():A();f=window.parent.postMessage&&window.JSON;m=!0;var u=!1;if("0"==dv_GetParam(q,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)u=!0;if(f&&0==u)try{var r=E(window._dv_win.dv_config.bst2turl||"https://cdn3.doubleverify.com/bst2tv3.html","bst2t_"+p);m=B(r)}catch(y){}r={};try{u=/[\?&]([^&]*)=([^&#]*)/gi;for(var t=u.exec(q);null!=t;)"eparams"!==t[1]&&(r[t[1]]=t[2]),t=u.exec(q);var g=r}catch(y){g=r}this.tagParamsObj=g;g.perf=this.perf;g.uid=p;g.script=this.dv_script;g.callbackName=
"__verify_callback_"+g.uid;g.tagObjectCallbackName="__tagObject_callback_"+g.uid;g.tagAdtag=null;g.tagPassback=null;g.tagIntegrityFlag="";g.tagHasPassbackFlag="";0==(null!=g.tagformat&&"2"==g.tagformat)&&(t=P(g.script),g.tagAdtag=t.tagAdTag,g.tagPassback=t.tagPassback,t.isBadImp?g.tagIntegrityFlag="&isbadimp=1":t.hasPassback&&(g.tagHasPassbackFlag="&tagpb=1"));(t=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&
!window.MSStream)?r="https:":(r=g.script.src,q="http:",p=window._dv_win.location.toString().match("^http(?:s)?"),"https"!=r.match("^https")||"https"!=p&&"http"==p||(q="https:"),r=q);g.protocol=r;g.ssl="0";"https:"===g.protocol&&(g.ssl="1");r=g;(q=window._dv_win.dvRecoveryObj)?("2"!=r.tagformat&&(q=q[r.ctx]?q[r.ctx].RecoveryTagID:q._fallback_?q._fallback_.RecoveryTagID:1,1===q&&r.tagAdtag?document.write(r.tagAdtag):2===q&&r.tagPassback&&document.write(r.tagPassback)),r=!0):r=!1;if(r)return{isSev1:!0};
this.dvStep=2;O(g,t);k=k&&k.parentElement&&k.parentElement.tagName&&"HEAD"===k.parentElement.tagName;this.dvStep=3;return G(this,g,b,c,e,d,f,m,k,t,h,n)};this.sendRequest=function(b){var c=dv_GetParam(b,"tagformat");if(u)try{u.setVersionData(this.getVersionParamName(),this.getVersion()),c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body,u.onLoad,u.onError,u.uniqueKey):dv_sendScriptRequest(b,u.onLoad,u.onError,u.uniqueKey)}catch(p){c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):
dv_sendScriptRequest(b)}else c&&"2"==c?$dvbs.domUtilities.addScriptResource(b,document.body):dv_sendScriptRequest(b);try{if("1"!=dv_GetParam(b,"foie")){var e=M(this.dv_script_obj&&this.dv_script_obj.injScripts),d=E("about:blank");d.id=d.name;var f=d.id.replace("iframe_","");d&&"function"===typeof d.setAttribute&&d.setAttribute("data-dv-frm",f);B(d,this.dv_script);if(this.dv_script){var n=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var m=b;break a}}catch(p){}try{if(b=window._dv_win.frames&&
window._dv_win.frames[d.name]){m=b;break a}}catch(p){}m=null}n.dvFrmWin=m}a:{var k;if(d&&(k=d.contentDocument||d.contentWindow&&d.contentWindow.document)){var h=k;break a}h=(k=window._dv_win.frames&&window._dv_win.frames[d.name]&&window._dv_win.frames[d.name].document)?k:null}if(h)h.open(),h.write(e);else{try{document.domain=document.domain}catch(p){}var q=encodeURIComponent(e.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));d.src='javascript: (function(){document.open();document.domain="'+window.document.domain+
"\";document.write('"+q+"');})()"}}}catch(p){e=window._dv_win.dv_config=window._dv_win.dv_config||{},e=dv_getDVBSErrAddress(e),d=[this.getVersionParamName(),this.getVersion()].join("="),e+=["/verify.js?ctx=818052&cmp=1619415&dvp_cert=3&num=6",d].join("&"),dv_SendErrorImp(e,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(p)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=G);this.getVersionParamName=function(){return"ver"};this.getVersion=
function(){return"141"}};
