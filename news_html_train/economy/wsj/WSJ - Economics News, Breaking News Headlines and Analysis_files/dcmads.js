...
try {
	...
	var __IntegralASConfig = {
		...
		protocol: 'https',
		jsref: "https:\/\/04128f73a63675b6641659bac557cd5b.safeframe.googlesyndication.com\/",
		asid: "a5577b47-d9af-11eb-b04c-024bf4a6d028",
		...
		mode: "rjss",
		requrl: "",
		dtBaseURL: "https:\/\/dt.adsafeprotected.com\/dt?advEntityId=716490",
		adsafeSrc: "https:\/\/fw.adsafeprotected.com\/rfw\/www.googletagservices.com\/716490\/54768295\/dcm\/dcmads.js",
		tpiLookupURL: "",
		getTpl: "false",
		use100v: false,
		useBapiCallback: "",
		useViewabilityNotification: "",
		scriptUrl: "https:\/\/fw.adsafeprotected.com\/rjss\/www.googletagservices.com\/716490\/54768295\/dcm\/dcmads.js",
		accountForSadImps: '',
		fwMonitoring: 'false',
		mn: "app11ie",
		mobOrTab: false,
		app: false,
		mobAppWebview: false,
		mobFwUrl: "https:\/\/mobile.adsafeprotected.com\/internal\/blocking\/app\/initial\/716490\/54768295?redirectUrl=https%3A%2F%2Fwww.googletagservices.com%2Fdcm%2Fdcmads.js",
		anId: '',
		advEntityId: '716490',
		pubEntityId: '54768295',
		videoId: '',
		rts: {},
		customViewability: [],
...
E.prototype.asStrings=function(){var h={};this.each(function(a,b){h[a]=""+b});return h};E.prototype.selectProperties=function(h){var a={},b=this;g(h).each(function(c,d){g.isDef(b.iterable[d])&&(a[d]=b.iterable[d])});return a};E.prototype.filter=function(h,a){return this.map(function(a,c){var d;if(g.isUndef(h)||g.resolve(h,a,c))d=c;return d},a)};E.prototype.toArray=function(){return this.map(function(h,a){return a})};E.prototype.JSONStringify=function(){var h,a,b=!1;v.Prototype&&v.Prototype.Version&&
-1===v.Prototype.Version.indexOf("1.7")&&(b=!0);b&&(a=Array.prototype.toJSON,delete Array.prototype.toJSON);h=JSON.stringify(this.iterable);b&&(Array.prototype.toJSON=a);return h};E.prototype.contains=function(h){var a=g(this.iterable).findFirst(function(a,c){return h===c});return g.isDef(a)};g.toBase=function(h,a){var b,c=0>h,d="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".split(""),e=[];h=c?-h:h;do b=h%a,e.push(d[b]),h=(h-b)/a;while(0<h);e=e.reverse().join("");return c?"-"+e:
...
e=function(c,d,e,q,u){u=u||{};var w,y,k=function(a){0===b.length&&(b=g(a).map(function(a,b){return h.request(b)}))},n=function(){if(!w){var a=[];w=!0;k(["features","browser","context"]);u.emits&&(c.events=new B);if(!u.applies||u.applies.apply(u,b))y=!0,a=g(e).map(function(a,b){return h.request(b)},!0),a.push(c),g(c).mixin(q.apply({},a))}};(function(){var b=u.tier;g.isDef(b)&&(a[b]=a[b]||new ba,a[b].push(n))})();h.provide(d,function(){var a;n();y&&(a=c);return a});return c};d.runAll=function(){var b=
...
q=function(){var a=!1;t.isOmid()&&f&&f.useOMID13Logic&&(a=!0);return a},u=function(a,b){h.save(k.RENDER.DIAGNOSTIC.CONTENT_STYLED);var c=/url(?:\(['"]?)(.*?)(?:['"]?\))/.exec(b.content)[1],d=s.createImage();d.onload=function(){0<d.naturalHeight*d.naturalWidth&&a.setAttribute&&a.setAttribute("data-ias-rend-bi",!1)};d.src=c;a.setAttribute("data-ias-rend-bi",!0)},w=function(a){var b={},c=r.getDoc(),d=function(e){var f=e&&e.type;if("readystatechange"===f&&"complete"===e.target.readyState||"load"===f)m(b),
...
return b},isInMobiMraidVideo:f,isDeviceTypeGroupMobile:q,usesIASFullyInViewCustomMetric:function(){return u("fiv")||l.use100v||!w()},usesGroupMCustomMetric:w,isCeltra:function(){var b=!1;a||(b=Ja().isApplicable());return b},usesGroupMCustomMetricMobilePassThru:function(){return w()&&q()},usesZeroPivCustomMetric:function(){return!1===g(l.customViewability).isArray()?!1:0<g(l.customViewability).filter(function(a,b){return g(b.thresholds).findFirst(function(a,b){return 0===b.piv})}).length},isRefreshable:function(a){try{var b=
...
"bs.serving-sys.com")}}}(v),z={addEvent:function(h,a,b,c){g.isDef(h.addEventListener)?"mouseenter"===a?h.addEventListener("mouseover",z.mouseEnter(b),c):"mouseleave"===a?h.addEventListener("mouseout",z.mouseEnter(b),c):h.addEventListener(a,b,c):g.isDef(h.attachEvent)&&("DOMContentLoaded"===a&&(a="load"),h.attachEvent("on"+a,b))},removeEvent:function(h,a,b){g.isDef(h.removeEventListener)?("mouseenter"===a?(a="mouseover",b=z.mouseEnter):"mouseleave"===a&&(a="mouseout",b=z.mouseEnter),h.removeEventListener(a,
...
e){a[b[e]]=d[e]});return a};a=function(){var a=e()[h],d=b&&b[h];g.isDef(d)&&0!==d&&g(c).contains(h)&&(a=a+"."+d);d=b[h];b[h]=g.isDef(d)?d+1:1;return a}();return{callType:h,enumerator:a}};Y.callTypeCounter={};var Zb=function(h,a,b,c,d,e,f,p){var m=0,q=0,u=!1,w=function(a,e,p,h,w,y){p=p||!b.on("postDts");var t=a===k.DT_CODES.DIAGNOSTIC||a===k.DT_CODES.ADTALK||a===k.DT_CODES.SCA||a===k.DT_CODES.XSCA||a===k.DT_CODES.EXTERNAL||a===k.DT_CODES.LARGE_BILLABLE;if(c.impressionIsIdentifiable()&&(t||"n"!==f.getCurrentLoc()))try{var s=
l.dtBaseURL,v=new Q(s,!0),z=r.now();n.getAggregator().trigger("preSendDt",a);s||(v.path("dt"),b.on("usedtdomain")&&v.sub("dt"));A(v,a,e);w&&w.field&&v.setParam(w.field,w.value);h||x(v,a);n.getAggregator().trigger("send",v,function(){q+=1;m=r.now()-z;g.isFunction(y)&&y()},p);a===k.DT_CODES.UNLOAD&&(u=!0);d.cleanup()}catch(D){__IntegralASDiagnosticCall("dt-"+a,D),n.getAggregator().trigger("error",k.ERROR_CODES.PHONE_HOME)}};h=function(){u||w(k.DT_CODES.UNLOAD,-1,!0)};var y=function(a,c){var d={bapi:"a",
...
u.NULL1=b.output();u.NULL2=f.stringify(10);u.em=t.embedded;u.fr=t.friendly;u.e=a.toString();u.tt=l.mode;u.dtt=m;d.filterOutput(function(a){var b=!a.standalone&&!a.minDt&&(!a.type||a.type===h);b&&a.oneTime&&(a.flagForRemoval=!0);return b},u);c.setParam("tv",u);c.setParam("br",e.getBrowserType())};n.getAggregator().on({sendDt:function(a,b,c){w(a,g.resolve(b),void 0,void 0,void 0,c)},sendMinDt:function(a,b){w(a,b,void 0,!0)},sendDiag:y,updateDtCount:function(){q++},unload:h});return{send:w,unload:h,
diagnostic:y,setViewabilityMod:function(a){}}},D=function(h){var a={},b=!1,c=function(){var a=1===h.nodeType?s.nodeIsHidden(h):0===h.width||0===h.height;return b?!1:a},d=function(){var b={};g(a).each(function(a,c){b[a]=r.round(c)});return b},e=function(a){return g.isNumeric(a)||g.isUndef(a)},f=function(){return r.round(a.width)*r.round(a.height)};(function(){var b;h!==v.parent&&(1!==h.nodeType?a=h:g.isDef(h.getBoundingClientRect)&&(b=s.getRect(h),g(a).mixin({x:g.useIfDef(b.x)||b.scrX,y:g.useIfDef(b.y)||
...
else throw h.width=h.height=0,"";else g.isDef(v.outerWidth)&&(h.width=v.outerWidth,h.height=v.outerHeight);return h},browserWindowPosition:function(){var h=0,a=0;g.isDef(v.screenX)?(h=v.screenX,a=v.screenY):g.isDef(v.screenLeft)&&(h=v.screenLeft,a=v.screenTop);n.getAggregator().request("browser").browserIs(k.BROWSERS.GECKO)&&-8==h&&-8==a&&(h+=8,a+=8);return{scrX:h,scrY:a}},getNodeArea:function(h){var a=-1;h&&(h=s.getRect(h),a=h.width*h.height);return a},getRect:function(h){var a={},b=s.browserWindowPosition();
...
c(p),f.hasValidSizeForMobileApp=p.hasValidSizeForMobileApp);return f},screenSize:function(){if(t.isDomless())return{width:0,height:0};var h={width:-1,height:-1};try{g.isDef(v.screen)&&(h={width:v.screen.width,height:v.screen.height})}catch(a){}return h},calcMonDims:function(){var h=g(s.screenSize()).mixin({scrX:0,scrY:0});g.isDef(screen.availLeft)&&(h={scrX:v.screen.availLeft,scrY:v.screen.availTop,width:v.screen.availWidth,height:v.screen.availHeight});return h},getOurIFrameInTop:function(){for(var h,
...
d.height),k=k-e,c=c-g;f=D({scrX:e,scrY:g,width:0<k?k:0,height:0<c?c:0})}}),e=r.round(f.area()/a.area()*100));return e}}},Gb=function(){var a,b=!1,c;a=function(a){var b=[];b.push(a.slice(0,8));b.push(a.slice(8,12));b.push(a.slice(12,16));b.push(a.slice(16,20));b.push(a.slice(20));return b.join("-")}(function(){var a="";try{for(var b,c=v.Uint32Array&&v.crypto&&v.crypto.getRandomValues;32>a.length;)c?(b=new Uint32Array(1),v.crypto.getRandomValues(b),a+=b[0].toString(16)):a+=(16*r.random()|0).toString(16);
...
d.hasValidDims()&&(b.ac=d,b.am=a.method,b.cc=a.containerDimensions);g({piv:"percentInView",obst:"obstructed",th:"tabHidden",reas:"reason"}).each(function(c,d){var e=a[d];g.isDef(e)&&(b[c]=e)});c=g(b).toParams();return""===c?"":","+c},u=function(a,c){var d=new Nc(c);return b[a]=d},w=function(a,b){return(b||"")+{inView:"i",outOfView:"o",na:"n",partialViewMinus:"pm",partialViewPlus:"pp"}[a]},l=function(){g(c).each(function(b,c){m[c]+=a.length?p-d:p});d=p},r=function(b){a.length&&l();g(b).each(function(a,
b){var d=c[a];d!==b&&"n"===d&&(m[b]+=m.n);c[a]=b});a.length||l()},x=function(a){var c,d=a.adDimensions?a.adDimensions.getRounded():{width:0,height:0};c=q(a);var e=a.omidObstructions,m={sl:w(a.viewState)};p=t.getTagTime();r(m);m.t=p;c=g({toString:function(){g(b).each(function(a,b){b.fastForward()});return"{"+g(m).toParams()+this.details+this.breakdowns+"}"},details:c,breakdowns:{piv:[],as:[],toString:function(){var a,b=function(a,b){return b.duration+"~"+b.state};a=""+("piv:["+g(this.piv).stringify(b)+
...
e)},adTalkMessageCollection:function(){return m},idMapModule:k,interFrameQuerySelector:function(a){return new ld(a)}})};return{isApplicable:function(a){return g.isDef(v.JSON)&&g.isDef(v.postMessage)&&!a.isAvid()&&(!a.isOmidNative()||a.isOmidForWeb())},start:function(){l();f.traverse(p.addFrame);u.startListening();u.sendToKnownFrames();n.getAggregator().once("stopAdTalk",function(){u.stopListening()});n.getAggregator().provide("adTalkEventAggregator",e)},sendAdTalkCall:u.sendAdTalkCall,getFrameMap:function(){g.isUndef(b)&&
(b=new Na(e));return b},getFrameMapIncludingPeerCase:function(){g.isUndef(c)&&(c=new Na(e,!0));return c},getIdMap:k}},dd=function(){return{isApplicable:function(){return!1},start:function(){}}},kd=function(a,b){var c,d=b.request("adProxy").myIdCard,e=b.request("frameCollection").getMe().getStringifiedPosition();c=n.getAggregator().request("features").on("swapids")?l.oid:l.asid;var f=a||{},g=l.asid,d=d.tagId,m=t.embedded,q=t.friendly,u=l.birthdate;c=c.split("-")[2];var w;t.friendly?w="["+k.AD_IDENTIFIER+
"-"+l.asid+"]":(w=r.getWindow(),w=w.location&&w.location.href,w='iframe[src*="'+(w&&w.replace(/^https?\:\/\//i,""))+'"]');return{messageContent:f,srcAsid:g,srcTagId:d,srcIsEmbedded:m,srcIsFriendly:q,srcBirthdate:u,iasCommonId:c,nodeSelector:w,positionStr:e,version:"0.1"}},gd=function(){var a={};return{add:function(b){var c=b&&b.srcAsid;c&&(a[c]=b)},map:function(b){return g(a).map(b)},has:function(b){return a[b&&b.srcAsid]}}},md=function(a,b,c,d){var e,f=a==v;e={position:b.slice(0),id:b.join("-"),
...
(C.unifiedId=l.unifiedId);var s;s=r.now()-d.sentTime;d.transferDuration=s;m=H=f.getFrame(l.id);g.isUndef(m)||g.isUndef(m.selfDescription)?(H=H||f.addFrame(c.source,l.id.split("-"),d),H.addInformationFromSrc(d,l),e()):H.addInformationFromSrc(d,l);(t=b&&a.request("idMapModule").isCandidateForMyIdMap(d))&&p()}catch(v){n.getAggregator().trigger("error",k.ERROR_CODES.ADTALK_DUBIOUS)}};return{sendAdTalkCall:p,sendToKnownFrames:function(){(new da).send(f)},startListening:function(){c=new Ea;c.listen(e,m,
...
c){return c.environment.accepts()})}}},Ac=function(a){var b=!1,c=!1,d=!1,e=!1,f=n.getAggregator().request("omidAdSessionContext");f.queuedOutputItems=[];var p=new fa,m=n.getAggregator().request("omidAdSessionVerificationParameters"),q=n.getAggregator().request("features"),k=r.getWindow(),w=(k=k&&k.omid3p)&&g.isFunction(k.registerSessionObserver)&&g.isFunction(k.addEventListener)?k:a,y=!1;f.omidEarlyExit=!1;f.mediaType="display";var A=!1,x=function(a,b){f.queuedOutputItems.push({code:a,value:b})},
